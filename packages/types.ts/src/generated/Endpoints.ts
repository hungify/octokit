...
import type { paths } from "#openapi-types.ts/packages/openapi-types";
...
export interface Endpoints {
   ...
   */
  "DELETE /repos/{owner}/{repo}/actions/caches": Operation<
   ...
   */
  "DELETE /repos/{owner}/{repo}/code-scanning/analyses/{analysis_id}": Operation<
   ...
   */
  "POST /repos/{owner}/{repo}/releases/{release_id}/assets": Operation<
    "/repos/{owner}/{repo}/releases/{release_id}/assets",
    "post"
  >;
  /**
   ...
   */
  "POST /users/{username}/packages/{package_type}/{package_name}/restore": Operation<
